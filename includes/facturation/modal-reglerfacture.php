  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
                ...
                <strong>Info!</strong> Facture de la consultation, cliquez sur "Réglez la facture" lorsque le patient aura réglé la totalité de la consultation.
          </div>
        <div class="row">
          <!--Facture -->
          <div class="col-lg-12">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" role="button"onclick="bddreglerfacture(<?php echo $idvisite ?>)" >Régler la facture</button>
      </div>
            <!-- </form> -->
    </div>
  </div>
...
<!-- js transmettre les données récuperées -->
  ...
  function bddreglerfacture(idvisite){
    ...
    jQuery.ajax({
          url : '/cabinetdentaire/includes/facturation/bdd-reglerfacture.php',
          method : 'post',
          data : data,
